...
#### 1.1 设计原理
**为了获取论文与电子书相关信息，本项目重点爬取了**** ACM DL ****及**** library genesis ****两个网站，并通过**** SciHub ****、**** slideserve ****、**** Youtube ****等网站获取相关的**** pdf ****、**** ppt ****、视频等信息。以**** ACM DL ****为例，其爬取的工作流程主要分为收集论文**** / ****电子书列表，爬取论文**** / ****电子书主要信息，爬取对应**** PPT ****和视频三个部分，**** library genesis ****爬取的工作流程具体工作流程如下图所示：**
